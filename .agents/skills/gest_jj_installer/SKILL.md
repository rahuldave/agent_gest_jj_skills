...
description: Install jj Gest package extras after npx installs the skills, including hooks, docs, templates, tools, and AGENTS guidance.
---
...
root-level package extras. When the user asks to install the jj Gest hooks,
docs, templates, tools, or AGENTS guidance, run the bundled helper from this
skill directory:
